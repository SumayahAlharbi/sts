...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/plugins/bootstrap-notifications/bootstrap-notifications.css">
    <!--[if lt IE 9]>
    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a id="p2" class="navbar-brand" href="#">Demo App</a>
        </div>
        ...
        var newNotificationHtml = `
          ...
          <a href="#">
              ...
              <div class="mail-contnet">
                  <h5>Luanch Admin</h5> <span class="mail-desc">`+data.message+`</span> <span class="time">9:30 AM</span> </div>
          </a>
        `;
