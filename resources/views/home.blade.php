      ...
      <div class="card-body text-center ">
        <ul class="list-inline m-b-0">
          <a href="{{url('/statusFilter?status=4')}}">
            <li>
              <h6 class="text-muted text-warning"><span class="label label-warning">Pending {{$ticketsStats->where('status_id','=','4')->count()}}</span></h6>
            </li>
          </a>
          <a href="{{url('/statusFilter?status=5')}}">
            <li>
              <h6 class="text-muted text-info"><span class="label label-primary"> In Progress {{$ticketsStats->where('status_id','=','5')->count()}}</span></h6>
            </li>
          </a>
          <a href="{{url('/statusFilter?status=2')}}">
            <li>
              <h6 class="text-muted text-info"><span class="label label-inverse"> Scheduled {{$ticketsStats->where('status_id','=','2')->count()}}</span></h6>
            </li>
          </a>
          <a href="{{url('/statusFilter?status=1')}}">
            <li>
              <h6 class="text-muted  text-success"><span class="label label-success"> Completed {{$ticketsStats->where('status_id','=','1')->count()}}</span> </h6>
            </li>
          </a>
          <a href="{{url('/statusFilter?status=3')}}">
            <li>
              <h6 class="text-muted  text-danger"><span class="label label-danger"> Unassigned {{$ticketsStats->where('status_id','=','3')->count()}}</span> </h6>
            </li>
          </a>
        </ul>
      </div>
...
<div class="row">
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body">
        <a href={{url('/groupFilter?group='.$group->id)}}>
...
<div class="row">
  <div class="col-lg-12 col-md-12">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title"><i class="far fa-calendar"></i> Today Tickets <span class="label label-light-inverse">{{$todayTicketsTotal}}</span></h3>
...
<div class="row">
  <div class="col-lg-12 col-md-12">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title"><i class="far fa-calendar"></i> Late Tickets <span class="label label-light-inverse">{{$lateTicketsTotal}}</span></h3>

        @if($lateTickets->isEmpty())
        <th> Nothing is pending</th>
      ...
      <a class="btn" href="{{route('ticket.lateTicket')}}" role="button">Show More <i class="fa fa-plus-circle"></i></a>
    </div>
  </div>
