      ...
      <div class="login-box">
        ...
        <div class="card">
                          ...
                          <ul class="nav nav-tabs profile-tab" role="tablist">
                              <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab">KSAU-HS Login</a>
                              </li>
                              <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Admin</a>
                              </li>
                          </ul>
                          <!-- Tab panes -->
                              ...
                              <div class="tab-pane active" id="home" role="tabpanel">
                                  <div class="card-body">
                                    <div class="form-group text-center m-t-20">
                                        <div class="col-xs-12">
                                            <a class="btn btn-primary btn-lg waves-effect waves-light" href="{{ url('login/graph')}}">{{ __('Login with KSAU-HS ID') }}</a>
                                        </div>
                                    </div>
